 ...
 */
@WebServlet("/search.b1")
public class Boadr1SearchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Boadr1SearchServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//페이징 처리 추가
				...
				ArrayList<HashMap<String,Object>> list = new BoardService().searchBoard1(currentPage,limit,searchValue,searchCategory);
