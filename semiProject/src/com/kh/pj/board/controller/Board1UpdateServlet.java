...
/**
 * Servlet implementation class Board1UpdateServlet
 */
@WebServlet("/update.b1")
public class Board1UpdateServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (ServletFileUpload.isMultipartContent(request)) {
			...
			int bno = Integer.parseInt(multiRequest.getParameter("num"));
			...
			if (result > 0) {
				...
				// 에러페이지로 메세지 전달
				request.setAttribute("msg", "사진게시판 수정 실패!");
