 ...
 */
@WebServlet("/selectAllList.b2")
public class Board2SelectAllServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Board2SelectAllServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<HashMap<String,Object>> list = new BoardService().selectList(currentPage,limit,boardCategory);
