...
/**
 * Servlet implementation class Boadr1SearchServlet
 */
@WebServlet("/search.b2")
public class Boadr2SearchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Boadr2SearchServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//페이징 처리 추가
				...
				ArrayList<HashMap<String,Object>> list = new BoardService().searchBoard2(currentPage,limit,searchValue,searchCategory,boardCategory);
				...
				if(list != null) {
					page = "views/community/board2/board2_List.jsp"; 
