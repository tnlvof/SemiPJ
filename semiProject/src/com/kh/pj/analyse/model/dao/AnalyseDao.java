...
public class AnalyseDao {
	...
	public HashMap<String, ArrayList<HashMap>> doAnalyse(String areaCode, Connection con) {
		...
		//테이블명
		String[] tableName = new String[]{"상권_지수지표","상권_추정매출","상권배후지_추정매출","상권_추정유동인구","배후지_추정유동인구","상권_상주인구","상권배후지_상주인구","상권_직장인구","상권배후지_직장인구","상권_아파트","상권배후지_아파트","상권_소득소비","상권배후지_소득소비","상권_집객시설","상권배후지_집객시설"};		
		//지표지수 테이블 컬럼명
		...
		String[][] colsName = new String[][]{지표지수, 추정매출, 추정매출, 추정유동인구, 추정유동인구, 상주인구, 상주인구, 직장인구, 직장인구, 아파트, 아파트, 소득소비, 소득소비, 집객시설, 집객시설};
