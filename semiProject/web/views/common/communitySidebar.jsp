...
<body>
		<div class="sidenav">
			...
			<a href="<%= request.getContextPath() %>/selectAllList.b2">자유게시판</a>
			<a href="<%= request.getContextPath() %>/selectAllList.b2">질문게시판</a>
			<a href="<%= request.getContextPath() %>/selectAllList.b2">가입인사</a>
			<a href="<%= request.getContextPath() %>/selectAllList.b2">창업아이템홍보</a>
		</div>
</body>
</html>