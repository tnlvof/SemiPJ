...
<body>
	...
	<div class="supportHeader">
		...
		<div align="center" class="support-btn">
			<button
				onclick="location.href='<%=request.getContextPath()%>/select.sp'">목록보기</button>
			<%
				if (loginUser != null && loginUser.getMemberId().equals("admin")) {
			%>
			<button onclick="location.href='<%= request.getContextPath() %>/selectNotice.sp?num=<%= s.getbNo() %>'">수정</button>
